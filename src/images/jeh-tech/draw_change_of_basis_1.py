...
if __name__ == '__main__':
    ...
    fig = plt.figure()
    axs = [fig.add_subplot(211), fig.add_subplot(212, projection='skewx')]
    ...
    for ax in axs:
        ...
        ax.set_ylim([-.005, 1.25])
    
    axs[0].set_title(r"$(1,0)$ and $(0,1)$ plotted w.r.t standard basis")
    axs[1].set_title(r"$(1,0)$ and $(0,1)$ plotted w.r.t basis $\{(1,1), (0,1)\}$")
